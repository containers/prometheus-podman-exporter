...
var _ = Describe("Container", func() {
	It("container metrics", func() {
		...
		expectedCnt01State := fmt.Sprintf("podman_container_state{id=\"%s\",image=\"%s\",image_id=\"%s\",name=\"%s\",pod_id=\"%s\",pod_name=\"%s\",ports=\"\"}",
			cnt01Inpect[0].ID[0:12], testBusyBoxImage, imageInspect[0].ID[0:12], testCnt01Name, cnt01Pod01Inspect.ID, cnt01Pod01Inspect.Name)

		expectedCnt01Created := fmt.Sprintf("podman_container_created_seconds{id=\"%s\",image=\"%s\",image_id=\"%s\",name=\"%s\",pod_id=\"%s\",pod_name=\"%s\",ports=\"\"}",
			cnt01Inpect[0].ID[0:12], testBusyBoxImage, imageInspect[0].ID[0:12], testCnt01Name, cnt01Pod01Inspect.ID, cnt01Pod01Inspect.Name)

		expectedCnt01ExitedSeconds := fmt.Sprintf("podman_container_exited_seconds{id=\"%s\",image=\"%s\",image_id=\"%s\",name=\"%s\",pod_id=\"%s\",pod_name=\"%s\",ports=\"\"}",
			cnt01Inpect[0].ID[0:12], testBusyBoxImage, imageInspect[0].ID[0:12], testCnt01Name, cnt01Pod01Inspect.ID, cnt01Pod01Inspect.Name)

		expectedCnt01ExitedCode := fmt.Sprintf("podman_container_exit_code{id=\"%s\",image=\"%s\",image_id=\"%s\",name=\"%s\",pod_id=\"%s\",pod_name=\"%s\",ports=\"\"}",
			cnt01Inpect[0].ID[0:12], testBusyBoxImage, imageInspect[0].ID[0:12], testCnt01Name, cnt01Pod01Inspect.ID, cnt01Pod01Inspect.Name)

		expectedCnt01RwSize := fmt.Sprintf("podman_container_rw_size_bytes{id=\"%s\",image=\"%s\",image_id=\"%s\",name=\"%s\",pod_id=\"%s\",pod_name=\"%s\",ports=\"\"}",
			cnt01Inpect[0].ID[0:12], testBusyBoxImage, imageInspect[0].ID[0:12], testCnt01Name, cnt01Pod01Inspect.ID, cnt01Pod01Inspect.Name)

		expectedCnt01RootFsSize := fmt.Sprintf("podman_container_rootfs_size_bytes{id=\"%s\",image=\"%s\",image_id=\"%s\",name=\"%s\",pod_id=\"%s\",pod_name=\"%s\",ports=\"\"}",
			cnt01Inpect[0].ID[0:12], testBusyBoxImage, imageInspect[0].ID[0:12], testCnt01Name, cnt01Pod01Inspect.ID, cnt01Pod01Inspect.Name)
